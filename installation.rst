...
Install the geo-blocking module for OXID e Shop Version 7.5.x.
...
The requirements of OXID eShop Version 7.5 or higher apply: https://docs.oxid-esales.com/eshop/en/7.5/installation/new-installation/server-and-system-requirements.html.
...
1. Download the module from the repository and install it.
   ...
   .. code:: bash
      ...
      composer require --update-no-dev oxid-esales/geo-blocking-module:^2.5.0
