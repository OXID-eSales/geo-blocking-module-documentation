...
The geo-blocking module provides functions that make it easy to implement the Geo-blocking Regulation in OXID eShop. It goes beyond what can be achieved with shop-specific settings and was presented in the German blog post `Geo-blocking Regulation: How to configure OXID eShop to be compliant? <https://forum.oxid-esales.com/t/geo-blocking-regulation-how-to-configure-oxid-eshop-to-be-compliant/>`_ on OXIDforge.
