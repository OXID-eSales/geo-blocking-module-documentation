...
html_context = {
    ...
    'languages': [
          ('DE', 'https://docs.oxid-esales.com/modules/geo-blocking/de/2.5/'),
          ('EN', 'https://docs.oxid-esales.com/modules/geo-blocking/en/2.5/')
     ],
