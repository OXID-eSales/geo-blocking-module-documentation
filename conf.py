...
html_context = {
    'current_version': '2.3',
    'versions': [
          ('1.0', 'https://docs.oxid-esales.com/modules/geo-blocking/en/1.0/'),
          ...
          ('2.4', 'https://docs.oxid-esales.com/modules/geo-blocking/en/2.4/'),
          ('2.5', 'https://docs.oxid-esales.com/modules/geo-blocking/en/2.5/'),
    ],
    'languages': [
...
#
# html_title = 'Geo-blocking v2.3.0'
